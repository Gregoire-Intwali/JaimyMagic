    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5F1EB] via-[#F5F1EB] to-[#E8DDD4]">
      ...
      <section className="relative py-20 px-4 text-center">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="mb-8">
            <Sparkles className="h-16 w-16 text-[#5E112C] mx-auto mb-4 animate-pulse" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-[#FEFCF8] border-[#5E112C]/30 hover:border-[#5E112C]/60 transition-all duration-300 group shadow-lg">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-[#5E112C]">Close-up Magie</CardTitle>
                <CardDescription className="text-[#5E112C]/70 text-lg">
                  Intieme magie uitgevoerd direct voor uw gasten
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-[#5E112C]/80 mb-6">
                ...
                <Button asChild variant="outline" className="border-[#5E112C] text-[#5E112C] hover:bg-[#5E112C] hover:text-[#FEFCF8]">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-r from-[#5E112C]/10 to-[#3D0B1C]/15">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button asChild size="lg" className="bg-[#5E112C] hover:bg-[#3D0B1C] text-[#FEFCF8] font-bold px-8 py-4 text-lg">
      ...
      {/* Footer */}
      <footer className="bg-[#5E112C] border-t border-[#FEFCF8]/20 py-8 px-4">
