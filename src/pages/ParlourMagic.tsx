    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5F1EB] via-[#F5F1EB] to-[#E8DDD4]">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="bg-[#FEFCF8] border-[#2E2F38]/30 text-center shadow-lg">
              <CardHeader>
                ...
                <CardTitle className="text-[#2E2F38]">Show Duur</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-[#2E2F38]/80">45-60 minuten voorstelling</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#FEFCF8] border-[#2E2F38]/30 text-center shadow-lg">
              <CardHeader>
                ...
                <CardTitle className="text-[#2E2F38]">Publiek Grootte</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-[#2E2F38]/80">Ideaal voor 10-50 personen</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#FEFCF8] border-[#2E2F38]/30 text-center shadow-lg">
              <CardHeader>
                ...
                <CardTitle className="text-[#2E2F38]">Stijl</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-[#2E2F38]/80">Klassiek met moderne flair</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#2E2F38] mb-6">De Voorstelling</h2>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#2E2F38]/80">Grootse effecten die het hele publiek boeien</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Sparkles className="h-6 w-6 text-[#2E2F38] mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-[#2E2F38]/80">Interactieve momenten waarbij uw gasten betrokken worden</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Sparkles className="h-6 w-6 text-[#2E2F38] mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-[#2E2F38]/80">De perfecte mix van humor en verbazing</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Sparkles className="h-6 w-6 text-[#2E2F38] mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-[#2E2F38]/80">Een spectaculair einde dat iedereen versteld doet staan</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <Card className="bg-[#FEFCF8] border-[#2E2F38]/30 shadow-lg">
            <CardHeader>
              <CardTitle className="text-2xl text-[#2E2F38] text-center">Wat U Moet Voorzien</CardTitle>
              <CardDescription className="text-[#2E2F38]/80 text-center text-lg">
            ...
            <CardContent className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-[#2E2F38]/80">
